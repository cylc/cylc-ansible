# Cylc Ansible: How to Contribute

## Report Bugs

Report bugs by opening an issue [on 
Github](https://github.com/cylc/cylc-ansible/issues). Give the version
...
](https://github.com/cylc/cylc-ansible/issues). Describe your use case in
detail.

## Contribute Code

All contributions to project are made via Pull Requests against the *master*
branch of [cylc/cylc-ansible](https://github.com/cylc/cylc-ansible).
Non-trivial developments must be discussed and agreed in advance in a
[Issue](https://github.com/cylc/cylc-ansible/issues) as the team may not
